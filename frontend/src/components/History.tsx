            ...
            >
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-xl border border-cyan/30 bg-cyan/10 px-3 py-2 text-xs text-cyan hover:bg-cyan/15 transition"
                >
...
function HistoryDetailsPanel({
  ...
  return (
    <section id="history-detail-panel" className="glass rounded-3xl border border-cyan/20 p-5 md:p-7">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <div className="mt-3 flex flex-wrap gap-2 text-xs text-muted-foreground">
            ...
            <span className="rounded-lg border border-border bg-surface/50 px-2.5 py-1">
              Target: <span className="text-soft">{record.target_url || record.domain}</span>
            </span>
            <span className="rounded-lg border border-border bg-surface/50 px-2.5 py-1">
