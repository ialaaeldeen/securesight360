...
class WebsiteRiskDeduction(BaseModel):
    """
    Explainable scoring deduction generated by the SecureSight360 risk engine.
    """
...
class WebsiteRiskAssessment(BaseModel):
    """
    Professional risk assessment returned by the SecureSight360 risk engine.
    """
...
class WebsiteScanResult(BaseModel):
    ...
    risk_assessment: WebsiteRiskAssessment | None = Field(
        default=None,
        description="Explainable SecureSight360 risk assessment for the scan.",
    )
